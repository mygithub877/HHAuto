...
- (void)testSQLite{
    [[HHCache sharedInstance] setObject:@"hahahahah" forKey:@"test" option:HHCacheOptionDiskOnly];
     NSString *object=[[HHCache sharedInstance]objectForKey:@"test"];
    HHLog(@"%@",object);
}
